...
Test_Description: "Verify synchronization of NTP server with OPS and
                  see if NTP client on OPS connects to atleast
                  one NTP server without using authentication"
