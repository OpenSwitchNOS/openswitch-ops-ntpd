...
### Test result criteria
#### Test pass criteria
If the ntp server name is more than 15 characters, `show ntp associations` output truncates the name to 15 characters and displays it.
#### Test Fail Criteria
The `show ntp associations` output does not truncate the server name if it is more than 15 characters, and the displayed name goes out of the table.
