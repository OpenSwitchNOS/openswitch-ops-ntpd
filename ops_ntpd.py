...
def ops_ntpd_get_ntpd_associations_info(ntpd_updates):
    ...
    for address in associations_info_table.keys():
        ...
        assoc_info[NTP_ASSOC_REMOTE_PEER_ADDRESS] = associations_info_table[address][NTPQ_REMOTE]
        assoc_info[NTP_ASSOC_REMOTE_PEER_REF_ID] = associations_info_table[address][NTPQ_REFID]
        ...
        assoc_info[NTP_ASSOC_LAST_POLLED] = associations_info_table[address][NTPQ_WHEN]
        assoc_info[NTP_ASSOC_POLLING_INTERVAL] = associations_info_table[address][NTPQ_POLL]
        assoc_info[NTP_ASSOC_REACH_REGISTER] = associations_info_table[address][NTPQ_REACH]
        assoc_info[NTP_ASSOC_NETWORK_DELAY] = associations_info_table[address][NTPQ_DELAY]
        assoc_info[NTP_ASSOC_TIME_OFFSET] = associations_info_table[address][NTPQ_OFFSET]
        assoc_info[NTP_ASSOC_JITTER] = associations_info_table[address][NTPQ_JITTER]
        assoc_info[NTP_ASSOC_ROOT_DISPERSION] = associations_info_table[address][NTPQ_ROOT_DISPERSION]
        assoc_info[NTP_ASSOC_PEER_STATUS_WORD] = translate_peer_status_word[\
            associations_info_table[address][NTPQ_PEER_STATUS_WORD]]
        assoc_info[NTP_ASSOC_ASSOCID] = associations_info_table[address][NTPQ_ASSOCID]
        assoc_info[NTP_ASSOC_REFERENCE_TIME] = associations_info_table[address][NTPQ_REFERENCE_TIME]
